...
%>
<div id="stock_all" style="width:100%; height:20%; border:1px solid ;padding:10px;">
<div id="stock_img" style="width:20%; height:100%; border:1px solid ;"><img src="<%=session_file_name.get(i)%>"></div>
<div id="stock_contents" style = "width: 50%; height:100%;border:1px solid;"><%=session_price.get(i)%>
<%=session_contents.get(i)%></div>

<div id="stock_cancel">
<form action="delete_cart.jsp"><button type="submit" name="delete" value=<%=i %>>삭제 </button></form>
</div>
</div>
